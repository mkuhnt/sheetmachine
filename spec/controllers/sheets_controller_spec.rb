...
describe SheetsController do
  ...
  describe "GET index" do
    it "assigns all sheets as @sheets" do
      ...
      assigns(:sheets).should eq([sheet])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sheet as @sheet" do
        ...
        post :create, {:sheet => {}}, valid_session
        assigns(:sheet).should be_a_new(Sheet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sheet" do
        sheet = Sheet.create! valid_attributes
        # Assuming there are no other sheets in the database, this
        # specifies that the Sheet created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Sheet.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => sheet.to_param, :sheet => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sheet as @sheet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sheet.any_instance.stub(:save).and_return(false)
        put :update, {:id => sheet.to_param, :sheet => {}}, valid_session
        assigns(:sheet).should eq(sheet)
      end
